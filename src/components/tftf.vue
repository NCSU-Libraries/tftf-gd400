<template>
  ...
  <div>
    <h4>for GD 400:</h4>
    <h4><i>Advanced Graphic Design Studio</i></h4> 
    <p>
  ...
  <div class="app">
    ...
    <p>
      Use <a href="https://docs.google.com/presentation/d/1Emd9-9mZismUoZNj8U6efKxAv1EC3sg0LK91PWXP-Y4/copy" target="_blank">this template</a> to respond to the prompt. 
      <br>
    </p>  
    <h3>  </h3>
...
export default {
  ...
  methods: {
    parse() {
      var vue = this;
        this.papaparse.parse('https://raw.githubusercontent.com/cullerth/tftf-gd400/main/src/data/tftf_data_all.csv', {
        header: true,
        download: true, 
